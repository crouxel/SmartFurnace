...
from constants import (
    MIN_TEMP, MAX_TEMP, validate_temperature, 
    validate_time_format, DEFAULT_TEMP, DEFAULT_TIME
)

@pytest.fixture(scope="session")
def qapp():
    """Create the QApplication instance for tests."""
...
def test_default_values(qtbot, qapp):
...
def test_first_row_auto_population(qtbot, qapp):
